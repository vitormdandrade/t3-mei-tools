...
export default function AbrirContaPJMEI() {
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">Como Abrir Conta PJ para MEI</h1>
        <p className="text-gray-600 dark:text-gray-400 text-lg">Guia completo para abrir uma conta bancária PJ/MEI com documentação necessária.</p>
      </div>

      <section className="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
        <h2 className="text-2xl font-bold text-blue-900 dark:text-blue-200 mb-2">Por que Abrir Conta PJ?</h2>
        <ul className="list-disc list-inside space-y-1 text-blue-900 dark:text-blue-200 text-sm">
      ...
      <section className="space-y-4">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Documentos Necessários</h2>
        <div className="space-y-3">
          <div className="border dark:border-gray-700 rounded-lg p-4">
            <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Documentos da Empresa (MEI)</h3>
          ...
          <div className="border dark:border-gray-700 rounded-lg p-4">
            <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Documentos Pessoais (Sócio/Proprietário)</h3>
            <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300 text-sm">
      ...
      <section className="space-y-4">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Passo a Passo</h2>
      ...
      <section className="space-y-4">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Melhores Bancos para MEI</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-4">Confira nosso comparativo completo:</p>
      ...
      <section className="space-y-4">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Custos Típicos</h2>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-800">
                <th className="border dark:border-gray-700 px-4 py-2 text-left font-bold">Serviço</th>
                <th className="border dark:border-gray-700 px-4 py-2 text-center font-bold">Custo</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border dark:border-gray-700 px-4 py-2">Abertura da conta</td>
                <td className="border dark:border-gray-700 px-4 py-2 text-center">Gratuito</td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-900">
                <td className="border dark:border-gray-700 px-4 py-2">Manutenção mensal</td>
                <td className="border dark:border-gray-700 px-4 py-2 text-center">Gratuito - R$ 30/mês</td>
              </tr>
              <tr>
                <td className="border dark:border-gray-700 px-4 py-2">Transferência (TED)</td>
                <td className="border dark:border-gray-700 px-4 py-2 text-center">Gratuito - R$ 15</td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-900">
                <td className="border dark:border-gray-700 px-4 py-2">Boleto bancário</td>
                <td className="border dark:border-gray-700 px-4 py-2 text-center">Gratuito - R$ 5</td>
              </tr>
            </tbody>
          </table>
        </div>
