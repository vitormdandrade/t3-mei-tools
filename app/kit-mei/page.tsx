...
export default function KitMEIPage() {
  ...
  return (
    <div className="space-y-12 max-w-4xl mx-auto">
      {/* Hero */}
      <section className="text-center py-10 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-8 border border-amber-200">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          ...
          <span className="text-amber-600">Prontos para Usar</span>
        </h1>
        ...
        <div className="flex gap-3 justify-center flex-wrap mt-4 text-sm">
          <span className="bg-white border border-green-200 text-green-800 px-3 py-1 rounded-full">
            🔒 Pagamento seguro via Stripe
          </span>
          <span className="bg-white border border-blue-200 text-blue-800 px-3 py-1 rounded-full">
            📥 Download imediato em ZIP
          </span>
          <span className="bg-white border border-purple-200 text-purple-800 px-3 py-1 rounded-full">
            📝 4 PDFs editáveis
          </span>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="flex gap-4 items-start">
            <div className="bg-amber-100 text-amber-800 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">
              1
            </div>
            <div>
              <h3 className="font-bold text-gray-900">Clique em Comprar</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className="bg-gray-50 rounded-lg p-8">
        ...
        <div className="space-y-4">
          <details className="border bg-white rounded-lg p-4">
